...
Widget listjobcards (BuildContext context,{VoidCallback? onTap , required String title1,
        ...
        Row(
          ...
          children: [
            textWidget(title1, AppColor.blackcolor, TextStyles.fontWeight400, TextStyles.fontSize13, TextAlign.left, TextStyles.ubuntumedium),
              textWidget('3 m ago', AppColor.attoureasycolor, TextStyles.fontWeight500, TextStyles.fontSize10, TextAlign.left, TextStyles.ubuntumedium),
        ],),
