...
Widget textformfiled(BuildContext context ,  String text ,bool obsecuretext,{TextEditingController? controller,TextInputType? keyboardtype , Widget? postfixIcon}) {
return Padding(
  ...
  child:   TextFormField(
    ...
    obscuringCharacter: '*',
    style: TextStyle(color: AppColor.activedotcolor , fontFamily: TextStyles.ubunturegular ,fontSize: TextStyles.fontSize14 , fontWeight: TextStyles.fontWeight400 ) ,
